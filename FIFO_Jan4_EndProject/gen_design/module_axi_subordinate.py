def gen_axi_subordinate (dataW, addressW,bus_name):
    code = [
    "//----------------------------------------------------------------------",
    "module axi_sub_inf"
    "       #(parameter  DATA_WITH= %d //num of data with"  % dataW,
    "                ,   ADDR_WITH = %d) //num of addressW" % addressW,
    "(",
    "      input                           s_axi_clk    , ",
    "      input                           s_axi_resetn , ",
    "           // AW CHANNEL                             ",
